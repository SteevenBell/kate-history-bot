...
@Slf4j
public class ChatMenuMessageHandler implements TelegramCommandHandler {
    ...
    public void handle(TelegramMessage message) {
        ...
        try {
            ...
            log.error("Ошибка при отправке меню Общение для chatId: " + chatId, e);
        }
    }

    @Override
    public String getCommand() {
        return MainMenuButtonEnum.CHAT.getText();
    }
}
