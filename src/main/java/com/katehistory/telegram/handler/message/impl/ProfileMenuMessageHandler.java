...
@Slf4j
public class ProfileMenuMessageHandler implements TelegramCommandHandler {
    ...
    public void handle(TelegramMessage message) {
        ...
        try {
            ...
            log.error("Ошибка при отправке меню Профиль для chatId: " + chatId, e);
        }
    }

    @Override
    public String getCommand() {
        return MainMenuButtonEnum.PROFILE.getText();
    }
}
